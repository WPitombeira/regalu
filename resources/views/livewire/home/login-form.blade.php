    ...
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="h-[70vh] flex flex-col items-center justify-center grow lg:py-0">
            <div class="flex flex-col items-center px-6 w-4/6">
                {{-- // Login --}}
                <div x-data="{ showLogin: @entangle('showLogin') }" x-show="showLogin"
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="#">
                            ...
                            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                                Don’t have an account yet? <a wire:click="toggleForm" href="#"
                ...
                {{-- // Register --}}
                <div x-data="{ showRegister: @entangle('showRegister')}" x-show="showRegister">
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Already have an account? <a wire:click="toggleForm" href="#"
